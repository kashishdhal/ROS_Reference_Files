...
#Create a Publisher to move the drone
move = rospy.Publisher('/cmd_vel', Twist, queue_size=1) 

#Create the empty message of type Twist to move the drone
move_msg = Twist() 

#Create a Publisher to takeoff the drone
takeoff = rospy.Publisher('/drone/takeoff', Empty, queue_size=1) 

#Create the message to takeoff the drone
takeoff_msg = Empty() 

#Create a Publisher to land the drone
land = rospy.Publisher('/drone/land', Empty, queue_size=1) 

#Create the message to land the drone
land_msg = Empty() 
