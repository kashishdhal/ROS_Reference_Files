...
class gurdyJointMover(object):
    ...
    def __init__(self):
        ...
        self.pub_upperlegM1_yaw_joint_position = rospy.Publisher(
            '/gurdy/upperlegM1_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.pub_upperlegM2_yaw_joint_position = rospy.Publisher(
            '/gurdy/upperlegM2_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.pub_upperlegM3_yaw_joint_position = rospy.Publisher(
            '/gurdy/upperlegM3_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)
        ...
        self.pub_headarm_yaw_joint_position = rospy.Publisher(
            '/gurdy/head_arm_yaw_joint_position_controller/command',
            Float64,
            queue_size=1)

        self.pub_headarm_joint_position = rospy.Publisher(
            '/gurdy/head_arm_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.pub_headforearm_joint_position = rospy.Publisher(
            '/gurdy/head_forearm_joint_position_controller/command',
            Float64,
            queue_size=1)
        # Add prismatic joints
        self.basefoot_peg_M1_basefoot_peg_M1_joint_joint_position = rospy.Publisher(
            '/gurdy/basefoot_peg_M1_basefoot_peg_M1_joint_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.basefoot_peg_M2_basefoot_peg_M2_joint_joint_position = rospy.Publisher(
            '/gurdy/basefoot_peg_M2_basefoot_peg_M2_joint_joint_position_controller/command',
            Float64,
            queue_size=1)
        self.basefoot_peg_M3_basefoot_peg_M3_joint_joint_position = rospy.Publisher(
            '/gurdy/basefoot_peg_M3_basefoot_peg_M3_joint_joint_position_controller/command',
            Float64,
            queue_size=1)
    ...
    def move_gurdy_all_joints(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, headarm_value, headforearm_value, upperlegM1_yaw_angle, upperlegM2_yaw_angle, upperlegM3_yaw_angle, headarm_yaw_value, basefoot_peg_M1_value, basefoot_peg_M2_value, basefoot_peg_M3_value):
        ...
        self.gurdy_move_ony_primsatic(basefoot_peg_M1_value, basefoot_peg_M2_value, basefoot_peg_M3_value)
    ...
    def gurdy_movement_look(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, headarm_value, headforearm_value, upperlegM1_yaw_angle, upperlegM2_yaw_angle, upperlegM3_yaw_angle, headarm_yaw_value, basefoot_peg_M1_value, basefoot_peg_M2_value, basefoot_peg_M3_value):
        """
        Move:
        ...
        while not (similar_upperlegM1 and similar_upperlegM2 and similar_upperlegM3 and similar_lowerlegM1 and similar_lowerlegM2 and similar_lowerlegM3 and similar_headarm and similar_headforearm and similar_upperlegM1_yaw and similar_upperlegM2_yaw and similar_upperlegM3_yaw and similar_headarm_yaw and similar_basefoot_peg_M1_value and similar_basefoot_peg_M2_value and similar_basefoot_peg_M3_value):
            ...
            similar_headarm = self.gurdy_check_continuous_joint_value(joint_name="head_arm_joint",
                                                                         value=position_headarm)
            similar_headforearm = self.gurdy_check_continuous_joint_value(joint_name="head_forearm_joint",
                                                                         value=position_headforearm)

            similar_upperlegM1_yaw = self.gurdy_check_continuous_joint_value(joint_name="upperlegM1_yaw_joint",
                                                                         value=position_upperlegM1_yaw)
            similar_upperlegM2_yaw = self.gurdy_check_continuous_joint_value(joint_name="upperlegM2_yaw_joint",
                                                                         value=position_upperlegM2_yaw)
            similar_upperlegM3_yaw = self.gurdy_check_continuous_joint_value(joint_name="upperlegM3_yaw_joint",
                                                                         value=position_upperlegM3_yaw)
            similar_headarm_yaw = self.gurdy_check_continuous_joint_value(joint_name="head_arm_yaw_joint",
                                                                         value=position_headarm_yaw)

            similar_basefoot_peg_M1_value = self.gurdy_check_continuous_joint_value(joint_name="basefoot_peg_M1_basefoot_peg_M1_joint_joint",
                                                                         value=position_basefoot_peg_M1_value)
            similar_basefoot_peg_M2_value = self.gurdy_check_continuous_joint_value(joint_name="basefoot_peg_M2_basefoot_peg_M2_joint_joint",
                                                                         value=position_basefoot_peg_M2_value)
            similar_basefoot_peg_M3_value = self.gurdy_check_continuous_joint_value(joint_name="basefoot_peg_M3_basefoot_peg_M3_joint_joint",
                                                                         value=position_basefoot_peg_M3_value)
    ...
    def jump(self, min_val=0.0, max_val=0.05, time_jump=1.0, direction="forwards"):
        ...
        if direction=="forwards":
            if time_jump != 0.0:
                ...
                self.gurdy_move_ony_primsatic(foot_m1=min_val,
                                            foot_m2=min_val,
                                            foot_m3=min_val)
                time.sleep(time_jump)
                rospy.logwarn("JUMP!")
                self.gurdy_move_ony_primsatic(foot_m1=max_val,
                                            foot_m2=min_val,
                                            foot_m3=min_val)
                time.sleep(time_jump)
    ...
    def decide_movement(self):
        ...
        if jump_magnitude == 0.0:
            ...
            max_value = 100.0
            min_value = 0.01
            jump_value_fixed = self.clamp(num=abs(jump_magnitude),
                        min_value=min_value,
                        max_value=max_value)
